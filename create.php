...
<div class="container px-4 full-height">
    <h1 class="title mt-4">Plan afspraak op <?=htmlentities($date)?> om <?=htmlentities($time)?></h1>
    ...
    <a class="button grey mt-5" href="date_time.php">&laquo; Andere datum en tijd kiezen</a>
    </div>
</body>
</html>
